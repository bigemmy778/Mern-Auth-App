...
const Login = () => {
    ...
    const onSubmitHandler = async (e) => {
        try {
            e.preventDefault();
            //in this api request we have to send the cookies
            //to send the cookies we have to make the withcredential true for this api request

            axios.defaults.withCredentials = true;


            if (state === 'Sign Up') {
                //make a call to the registration api
